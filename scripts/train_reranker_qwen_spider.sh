python 1_build_graph.py --split train --dataset spider --use-merged
python 1_build_graph.py --split dev --dataset spider --use-merged

cd embedder/ 
python 1_create_data_from_graph.py train --dataset spider

torchrun --nproc_per_node 1 \
	-m FlagEmbedding.finetune.reranker.decoder_only.base \
	--model_name_or_path /home/datht/huggingface/Qwen/Qwen3-Reranker-0.6B \
    --use_lora True \
    --lora_rank 32 \
    --lora_alpha 64 \
    --use_flash_attn True \
    ...
    --train_data ./data/spider_train_sts_all_cols.jsonl \
    ...
    --output_dir ./output/finetuned-reranker-qwen3-0.6B-spider \
...
torchrun --nproc_per_node 1 \
    ...
    --passage_instruction_for_rerank '\n<Document>: ' \
    --passage_instruction_format '{}{}<|im_end|>\n<|im_start|>assistant\n<think>\n\n</think>\n\n' \
    --output_dir ./output/finetuned-reranker-qwen3-4B-spider \
    --overwrite_output_dir \
    --learning_rate 2e-4 \
    --fp16 \
    --num_train_epochs 1 \
